...
### Added
- Added activation-focused GEO documentation for downloads, installs, API adoption, and agent invocation analysis.
- Added agent-readiness, developer-tool surface priority, and scientific product GEO playbooks.
...
- Added CLI entry point via `python -m geo_monitor` for run, report, leaderboard, and validate tasks.
